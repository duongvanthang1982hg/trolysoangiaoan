...
<div class="main-header">
    ...
    <p>Tác giả: Dương Văn Thắng - Trường PTDTBT Tiểu học Lùng Tám  - ĐT: 0386 821 305</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dương Văn Thắng - Trường PTDTBT Tiểu học Lùng Tám - ĐT: 0386 821 305</div>", unsafe_allow_html=True)
